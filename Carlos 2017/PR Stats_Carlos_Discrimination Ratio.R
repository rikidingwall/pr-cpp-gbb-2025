...
posthoc_model <- glmmTMB(Discrimination_Ratio ~ Genotype * Date.Time + (1|Animal.ID), 
                 data = cleaned_d, 
                 family = beta_family)
...
cleaned_d <- d[!is.na(d$Discrimination_Ratio) & d$Discrimination_Ratio != "", ]
cleaned_d <- cleaned_d[, c("Genotype", "Animal.ID", "Date.Time", "Discrimination_Ratio")]
write_xlsx(cleaned_d, "/Users/rikidingwall/Downloads/carlos-pr-discrim-ratio.xlsx")
...
cleaned_d <- cleaned_d[, c("Ratio", "Genotype", "Animal.ID", "Date.Time", "Discrimination_Ratio")]
write_xlsx(cleaned_d, "/Users/rikidingwall/Downloads/carlos-fr-discrim-ratio.xlsx")
