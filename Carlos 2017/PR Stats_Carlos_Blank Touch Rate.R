...
cleaned_d <- d[!is.na(d$Blank_Touches_Rate) & d$Blank_Touches_Rate != "", ]
...
posthoc_model <- glmmTMB(Blank_Touches_Rate ~ Genotype * Date.Time +(1|Animal.ID), 
                 data = cleaned_d, 
                 family = beta_family)
...
cleaned_d <- d[!is.na(d$Blank_Touches_Rate) & d$Blank_Touches_Rate != "", ]
cleaned_d <- cleaned_d[, c("Genotype", "Animal.ID", "Date.Time", "Blank_Touches_Rate")]
write_xlsx(cleaned_d, "/Users/rikidingwall/Downloads/carlos-pr-blank-touch-rate.xlsx")
...
cleaned_d <- cleaned_d[, c("Genotype", "Animal.ID", "Date.Time", "Blank_Touches_Rate")]
write_xlsx(cleaned_d, "/Users/rikidingwall/Downloads/carlos-fr-blank-touch-rate.xlsx")
