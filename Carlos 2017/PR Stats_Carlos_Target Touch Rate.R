...
cleaned_d <- d[!is.na(d$Target_Touches_Rate) & d$Target_Touches_Rate != "", ]
cleaned_d <- cleaned_d[, c("Genotype", "Animal.ID", "Date.Time", "Target_Touches_Rate")]
write_xlsx(cleaned_d, "/Users/rikidingwall/Downloads/carlos-pr-target-touch-rate.xlsx")
...
cleaned_d <- cleaned_d[, c("Genotype", "Animal.ID", "Date.Time", "Target_Touches_Rate")]
write_xlsx(cleaned_d, "/Users/rikidingwall/Downloads/carlos-fr-target-touch-rate.xlsx")
